			...
			<div className="flex-1 flex flex-col overflow-hidden h-full">
				...
				<div className="flex-1 flex flex-col items-center justify-center p-4 overflow-auto">
					<h1 className="text-4xl font-medium">
						<span className="bg-gradient-to-r from-[#52B69A] to-[#34A0A4] bg-clip-text text-transparent">
							Hello,
						</span>
						<span className="bg-gradient-to-r from-[#34A0A4] to-[#168AAD] bg-clip-text text-transparent">
							{" "}
							(Insert Name Here)
						</span>
					</h1>
